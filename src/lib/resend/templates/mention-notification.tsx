    ...
    <Html>
      ...
      <Body style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#f9fafb' }}>
        <Container style={{ maxWidth: '560px', margin: '40px auto', padding: '24px', backgroundColor: '#fff', borderRadius: '8px' }}>
          ...
          <Section style={{ backgroundColor: '#f3f4f6', padding: '12px 16px', borderRadius: '6px', borderLeft: '4px solid #00274c' }}>
            <Text style={{ color: '#374151', margin: 0 }}>{commentBody}</Text>
          </Section>
          <Button
            href={issueUrl}
            style={{ backgroundColor: '#00274c', color: '#fff', padding: '12px 24px', borderRadius: '6px', marginTop: '24px', display: 'inline-block', textDecoration: 'none' }}
          >
            View Issue
          </Button>
